...
public class NewsHandler extends AbstractHandler {
    ...
    /**
     *  The Constant CATEGORY_COLLECTION_NAME contains the name of the collection to store the categories in
     */
    public static final String CATEGORY_COLLECTION_NAME = "newsCategory";
    
    /**
     *  The Constant META_CATEGORY_COLLECTION_NAME contains the name of the collection to store the metacategories in
     */
     ...
     */
    public NewsHandler(CamelContext context, String host, int port, String db, String responseRoute, String webpath) throws Exception {
     ...
     *
     * @param entity The item to delete
     */
     ...
     *
     * @param category the NewsCategory object
     * @param news the News object to reference to
     * @throws Exception the exception
     */
    private void handleCategory(NewsCategory category, News news) throws Exception {
        ...
        if (item != null) {
            ...
            if (tmpNews != null) {
                DBRef ref = new DBRef(mdb, NEWS_COLLECTION_NAME, tmpNews.get("_id"));
     ...
     *
     * @param metaCat the NewsMetaCategory object
     * @param category the NewsCategory object to reference to
     * @throws Exception the exception
     */
