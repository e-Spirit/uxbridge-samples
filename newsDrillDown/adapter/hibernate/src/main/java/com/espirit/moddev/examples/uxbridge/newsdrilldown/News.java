 ...
 * News
 * 
 * The News which will be persisted to the table 'newsdrilldown'.
 */
@Entity(name= "news")
@Table(name = "newsdrilldown")
@org.hibernate.annotations.Table(appliesTo = "newsdrilldown",
indexes = {
        @Index(name = "IDX_fsid_lang_1",
